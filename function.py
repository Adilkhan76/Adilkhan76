...
'''2. Write a python program to create a function which expects two arguments and
print them in the function body.
def Takes_Two(a,b):
    print(a,b,end=' ')'''

'''3. Write a python program to create a function which expects an unknown number
of arguments.'''
def my(*args):
    print(type(*args))
    for num in args:
...
#6. Write a python program to create a function that finds a maximum of 4 numbers.
#def maximum(num):
